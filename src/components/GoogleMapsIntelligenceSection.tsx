    ...
    <section id="google-maps-intelligence" className="space-y-4 mb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-slate-200">
        ...
        <div className="flex items-center gap-2 shrink-0 text-xs">
          <div className="bg-slate-50 px-3 py-1 rounded border border-slate-200 font-mono text-slate-700">
            {locations.length} ubicaciones auditadas
          </div>
          <div className="bg-slate-50 px-3 py-1 rounded border border-slate-200 font-mono text-amber-400">
            ★ 4.7 prom.
          </div>
        </div>
      </div>
      ...
      <div className="flex flex-wrap items-center justify-between gap-2 benchia-card p-3 text-xs">
        <div className="flex flex-wrap items-center gap-2">
          ...
          <select
            ...
            className="bg-slate-50 text-slate-700 text-[11px] rounded px-2.5 py-1 border border-slate-200 outline-none cursor-pointer"
          >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-4">
        ...
        <div className="lg:col-span-7 benchia-card p-4 flex flex-col justify-between space-y-3">
          <div className="flex items-center justify-between">
            <span className="text-xs font-semibold text-slate-800">Radar de Cobertura Geográfica</span>
            <span className="text-[10px] text-slate-400 font-mono">Coordenadas WGS84</span>
          </div>

          {/* Map Surface */}
          <div className="relative w-full h-[320px] bg-slate-50 rounded border border-slate-200 overflow-hidden flex items-center justify-center p-4 bg-grid-subtle">
          ...
          <div className="flex items-center space-x-1.5 overflow-x-auto pt-1">
            {locations.map((loc) => (
              ...
              >
                <span>{loc.city}</span>
                <span className="ml-1 text-[10px] font-mono text-slate-400">({loc.rating}★)</span>
              </button>
            ))}
          </div>
        </div>
            ...
            <div className="space-y-3 text-xs">
              ...
              <div className="grid grid-cols-2 gap-2">
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200">
                  <span className="text-[10px] text-slate-400 uppercase block">Google Rating</span>
                  <div className="flex items-center space-x-1 mt-0.5 font-mono">
                    <Star className="w-3.5 h-3.5 text-amber-400 fill-amber-400" />
                    <span className="text-base font-bold text-slate-900">{activeLocation.rating}</span>
                ...
                <div className="bg-slate-50 p-2.5 rounded border border-slate-200">
                  <span className="text-[10px] text-slate-400 uppercase block">Gama de Precio</span>
              ...
              <div className="bg-slate-50 p-2.5 rounded border border-slate-200 space-y-1.5">
                ...
                <div className="pt-1.5 border-t border-slate-200 text-[10px] text-slate-400 font-mono">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="w-full py-2 px-3 rounded bg-slate-100 hover:bg-slate-200 text-slate-900 text-xs font-medium flex items-center justify-center space-x-1.5 border border-slate-200 transition-colors cursor-pointer"
              >
