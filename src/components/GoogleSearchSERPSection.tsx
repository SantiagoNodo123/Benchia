    ...
    <section id="google-search-serp" className="space-y-4 mb-10">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3 pb-2 border-b border-zinc-800">
        ...
        <a
          ...
          target="_blank"
          rel="noreferrer"
          className="text-xs text-zinc-400 hover:text-zinc-200 flex items-center space-x-1 self-start sm:self-auto"
        >
      ...
      <div className="benchia-card p-3 space-y-2">
        <div className="flex flex-col sm:flex-row items-center gap-2">
          <div className="relative flex-1 w-full">
            ...
            <input
              ...
              className="w-full bg-zinc-900 text-zinc-200 text-xs pl-8 pr-3 py-2 rounded border border-zinc-700 outline-none focus:border-zinc-500"
            />
          </div>
        ...
        <div className="flex items-center space-x-1.5 overflow-x-auto pt-1">
          <span className="text-[10px] text-zinc-500 font-medium shrink-0">Sugerencias:</span>
          {[
            `mejor ${niche}`,
            `precios ${niche}`,
            ...
            <button
              ...
              className="px-2 py-0.5 rounded bg-zinc-900 hover:bg-zinc-800 text-[10px] text-zinc-400 hover:text-zinc-200 border border-zinc-800 whitespace-nowrap transition-colors cursor-pointer"
            >
              {q}
            </button>
          ))}
        ...
        <div className="lg:col-span-8 space-y-3">
          ...
          <div className="flex items-center justify-between benchia-card px-3 py-2 text-xs">
            <div className="text-[11px] text-zinc-400">
              Ranking para: <span className="text-zinc-200 font-mono">"{liveQuery}"</span>
            </div>
              ...
              >
                ...
                <div className="flex items-center justify-between">
                  <div className="flex items-center space-x-2">
                    ...
                    <div className="text-[11px] text-zinc-400 truncate font-mono flex items-center space-x-1">
                      <span className="text-zinc-300 font-medium">{serp.competitorName}</span>
                      <span className="text-zinc-600">›</span>
                      <span className="truncate text-zinc-500">{serp.url}</span>
                    </div>
                  </div>
                ...
                <a
                  ...
                  target="_blank"
                  rel="noreferrer"
                  className="block text-sm font-semibold text-zinc-100 hover:text-emerald-400 transition-colors leading-snug"
                >
                  {serp.pageTitle}
                </a>
                ...
                <div className="pt-2 border-t border-zinc-800/80 flex flex-wrap items-center justify-between gap-2 text-[10px]">
                  <div className="flex flex-wrap items-center gap-1">
                    {serp.serpFeatures?.map((feature) => (
                      <span
                        key={feature}
                        className="px-1.5 py-0.2 rounded bg-zinc-900 text-zinc-400 border border-zinc-800 font-mono"
                      >
                        {feature}
                      </span>
                    ))}
                  ...
                  <div className="flex items-center space-x-2 text-zinc-500 font-mono">
                    <span>DA: <strong className="text-zinc-200">{serp.domainAuthority}</strong>/100</span>
          ...
          <div className="benchia-card p-4 space-y-3">
            ...
            <div className="space-y-2 text-xs">
              <div className="bg-zinc-950 p-2.5 rounded border border-zinc-800">
                <span className="text-[10px] text-zinc-500 uppercase block">Volumen Mensual</span>
              ...
              <div className="bg-zinc-950 p-2.5 rounded border border-zinc-800 font-mono text-[11px]">
                <span className="text-[10px] text-zinc-500 uppercase block mb-1">Estimación CTR por Posición</span>
                <div className="space-y-1">
                  <div className="flex justify-between text-zinc-300">
                    <span>#1 (Líder)</span>
                    <span className="text-zinc-100 font-bold">32.8%</span>
                  </div>
                  ...
                  <div className="flex justify-between text-zinc-300 pt-1">
                    <span>#2</span>
                    <span className="text-zinc-100 font-bold">16.4%</span>
                  </div>
                  <div className="w-full bg-zinc-800 h-1 rounded-full overflow-hidden">
                  ...
                  <div className="flex justify-between text-zinc-300 pt-1">
                    <span>#3</span>
                    <span className="text-zinc-100 font-bold">10.2%</span>
                  </div>
                  <div className="w-full bg-zinc-800 h-1 rounded-full overflow-hidden">
            ...
            <div className="space-y-1.5">
              {keywordOpportunities.map((kw, idx) => (
                <button
                  ...
                  className="w-full p-2 rounded bg-zinc-950 hover:bg-zinc-900 text-left border border-zinc-800 transition-colors flex items-center justify-between group cursor-pointer text-xs"
                >
                  <span className="text-zinc-300 group-hover:text-white truncate">
                    {kw}
                  </span>
                  <ArrowUpRight className="w-3 h-3 text-zinc-500 group-hover:text-emerald-400 shrink-0 ml-1" />
                </button>
              ))}
            </div>
          </div>
