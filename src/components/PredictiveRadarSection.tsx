          ...
          >
            <div>
              ...
              <div className="flex flex-wrap items-center justify-between gap-2 mb-2.5">
                <span className="text-[10px] px-1.5 py-0.2 rounded bg-slate-50 text-slate-500 border border-slate-200 font-mono">
                  {pred.category}
                </span>
                ...
                <div className="flex items-center space-x-1.5">
                  ...
                  <span className="text-[10px] px-1.5 py-0.2 rounded bg-slate-50 text-slate-700 border border-slate-200 font-mono flex items-center">
              ...
              <div className="p-2.5 rounded bg-slate-50 border border-slate-200 text-xs mb-2.5">
              ...
              <div className="p-2.5 rounded bg-slate-50 border border-slate-200 text-xs mb-3">
                ...
                <p className="text-slate-800 text-xs font-normal leading-relaxed">
            ...
            <div className="pt-2.5 border-t border-slate-200 flex items-center justify-between text-xs font-mono">
              <div className="flex items-center space-x-1.5 text-[11px] text-slate-500">
                ...
                <strong className="text-slate-900">{pred.confidenceScore}%</strong>
              </div>

              <div className="w-24 bg-slate-50 border border-slate-200 h-1.5 rounded-full overflow-hidden">
                <div
